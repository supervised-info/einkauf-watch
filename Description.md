...
- [ ] Einkauf-Artikel: `imported` nur Inbox-Abruf / expliziter Fremd-Datei-Anhang (nie Siri/Tippen/Stamm/Saved-List; Backup-Restore und eigenes PDF stempeln nicht); UI-Streifen teal/`theme.slate`, read-only. `urgency` Chip ⚡ / leerer umrandeter Chip / ↓ (nicht ○, nicht –), Zyklus eilig→normal→später, iPhone und Watch. Nicht auf To-Do.
